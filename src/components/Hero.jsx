        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-8 col-xl-8 col-xxl-6 text-lg-start text-center">
                    ...
                    <p className="lead mb-4 text-white txt-sh fw-medium hero-txt">Descubra caminhos para transformar sua trajetória profissional com orientação especializada e uma comunidade que apoia seu crescimento.</p>
